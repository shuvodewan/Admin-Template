$(function(){
   ...
   $('#enable').click(function() {
    ...
    $('#editable-meeting_start').editable({
    ...
    $('#editable-pencil').on("click", function(e) {
        e.stopPropagation();
        e.preventDefault();
   ...
   $('#editable-user .editable').on('hidden', function(e, reason){
